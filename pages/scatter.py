...
# Sort data by 'Year Built' in ascending order
data = data.sort_values(by='Year Built')
...
def create_map(style, df=None, highlight_id=None, measure_col='ENERGY STAR Score'):
    ...
    fig = px.scatter_mapbox(
        ...
        range_color=[df[measure_col].min(), df[measure_col].max()]
    )
    ...
    dbc.Row([
        dbc.Col([
            ...
            dbc.Select(
                ...
                style={  # Itt kell biztosítani a fekete háttérstílust
